...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        services::services::pipeline_types::PipelineConfig::decl(),
        services::services::pipeline_types::StageConfig::decl(),
        services::services::pipeline_types::PipelineStatus::decl(),
        services::services::pipeline_types::VerdictStatus::decl(),
        services::services::pipeline_types::VerdictIssue::decl(),
        services::services::pipeline_types::Verdict::decl(),
        services::services::pipeline_types::HandoffArtifact::decl(),
        services::services::pipeline_types::StageHistoryEntry::decl(),
        server::routes::workspaces::pipeline::PipelineStatusResponse::decl(),
