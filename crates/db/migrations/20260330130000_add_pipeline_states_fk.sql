...
CREATE TABLE pipeline_states_new (
    id                  BLOB PRIMARY KEY,
...
INSERT INTO pipeline_states_new SELECT * FROM pipeline_states;
DROP TABLE pipeline_states;
ALTER TABLE pipeline_states_new RENAME TO pipeline_states;
